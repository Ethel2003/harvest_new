    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-lg p-8 relative">
        ...
        <div className="mb-4 text-gray-500 text-sm">
          Merci de renseigner les informations pour enregistrer une nouvelle
          disponibilité.
        </div>
        <hr className="mb-6" />
        {/* Formulaire */}
        ...
        >
          <div>
            <label className="font-semibold mb-1 block">Pasteur/Leader</label>
            <input
              ref={firstInputRef}
          ...
          <div>
            ...
            <input
              ...
              aria-label="Date ou jour de la semaine"
            />
          </div>
          <div>
            <label className="font-semibold mb-1 block">
            ...
            <select className="w-full border rounded px-3 py-2 focus:ring-2 focus:ring-[#76C12C] focus:border-[#76C12C] transition">
              <option>Sélectionner la ou les plage(s) horaires...</option>
            </select>
          </div>
          {/* Boutons */}
          <div className="flex justify-end gap-4 mt-6">
            ...
            <button
              ...
              aria-label="Ajouter la disponibilité"
            >
